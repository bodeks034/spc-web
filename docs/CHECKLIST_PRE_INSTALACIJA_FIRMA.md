...
- [ ] `docs/UPUTSTVO_FIRMINSKI_SERVER.md` — puni vodič
- [ ] `docs/UPUTSTVO_ZASTITA_KODA_I_LICENCA.md` — licenca (interno za tebe + ugovor)
...
| `docs/UPUTSTVO_FIRMINSKI_SERVER.md` | Kompletan deploy vodič |
| `docs/UPUTSTVO_ZASTITA_KODA_I_LICENCA.md` | Licenca i zaštita koda |
