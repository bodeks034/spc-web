...
Kad lokalni test radi, sledeći korak je produkcija u fabrici: **`docs/UPUTSTVO_FIRMINSKI_SERVER.md`**

## Povezana dokumentacija

- `docs/MIGRACIJE.md` — redosled SQL migracija
- `docs/UPUTSTVO_FIRMINSKI_SERVER.md` — prebacivanje na interni server
