...
**Modul 0 šifrarnik (A4):** [OBUKA_MODUL_SIFARNIK.html](./OBUKA_MODUL_SIFARNIK.html) — otvori u browseru → Štampaj / Save as PDF
...
- `docs\obuka-paket\UPUTSTVO_PRAVLJENJE_BARKODOVA.md` — Excel registar etiketa + štampa  
