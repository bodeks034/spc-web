...
**Pre odlaska u firmu** popuni: `docs/obuka-paket/CHECKLIST_PRE_INSTALACIJA_FIRMA.md` (šta tačno tražiš od IT-a + šta ti moraju vratiti).
...
Detalji: `docs/obuka-paket/UPUTSTVO_LOKALNA_BAZA.md`.
...
Radi u Chrome/Edge na HTTPS stranici fabrike — vidi `docs/obuka-paket/UPUTSTVO_BARKOD_I_MERILA.md`.
...
| `docs/obuka-paket/UPUTSTVO_LOKALNA_BAZA.md` | Backup i lokalni test |
...
Posle deploy-a: **`docs/obuka-paket/UPUTSTVO_ZASTITA_KODA_I_LICENCA.md`** (zaštita izvora, uključivanje/isključivanje po datumu).
