...
export const UPUTSTVO_DOKUMENTI = [
  ...
  {
    id: "dobavljaci-prijemna-kontrola",
    kategorija: "koriscenje",
    naslov: "Dobavljači i prijemna kontrola",
    opis: "Modul 0 Dobavljači, Modul 1 PRIJEM, Ulazna kontrola, PPM i ocena A–D u Modulu 2",
    fajl: "/obuka-paket/UPUTSTVO_DOBAVLJACI_I_PRIJEMNA_KONTROLA.md",
    tip: "markdown",
    uloge: KANCELARIJA,
    obukaPaket: true,
  },
  ...
  {
    id: "primer-rucni-unos-ham-nm-001",
    kategorija: "koriscenje",
    naslov: "Vežba — ručni unos HAM-NM-001",
    opis: "Trening crtež i šest karakteristika K1–K6 na linijama A, B i E",
    fajl: "/obuka-paket/PRIMER_RUCNI_UNOS_HAM_NM_001.md",
    tip: "markdown",
    uloge: KANCELARIJA,
    obukaPaket: true,
  },
  ...
  {
    id: "erp-sop-uvoz-izvoz",
    kategorija: "erp-it",
    naslov: "SOP — ERP uvoz, izvoz i povezivanje",
    opis: "Korak po korak: izbor podataka, smeštanje u Šifrarnik, vozilo–deo veze i ERP izvoz",
    fajl: "/obuka-paket/SOP_ERP_UVOZ_IZVOZ_I_POVEZIVANJE.md",
    tip: "markdown",
    uloge: ADMIN,
  },
  {
