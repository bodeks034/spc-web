...
export default function KalibracijaMerila({ korisnik, C, addToast }) {
      ...
      <div style={{display:"flex",gap:10,marginTop:4}}>
        <button onClick={()=>onSnimi(f)} disabled={!mozeSnimiti}
          style={{flex:1,background:mozeSnimiti?C.zelena:C.hover,border:"none",borderRadius:8,
            color:mozeSnimiti? C.onAkcent:C.sivi,fontSize:13,fontWeight:700,padding:"12px",cursor:"pointer"}}>
          Snimi merilo
        </button>
