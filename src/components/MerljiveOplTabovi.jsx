...
export function CiljeviMerljive({ C, addToast, sviDelovi }) {
  ...
  const exportOpts = { naslov: "Ciljevi kvaliteta (merljive)", prefiks: "Ciljevi_merljive", ostvaren };
  ...
  return (
    <div ref={izvozRef} style={{ padding: 18, flex: 1, overflow: "auto" }}>
